               ...
               require_once("../conexion.php");
                ...
                if(!$conn){
                   ...
                   echo "Descripcion del error: " . PHP_EOL . "</br>";
                    ...
                    $sql = "SELECT sNombre, sFoto FROM JUEGO WHERE iIdJuego NOT IN (SELECT iIdJuego FROM USUARIO_JUEGO WHERE iIdUsuario = (SELECT iIdUsuario FROM USUARIO WHERE sUser = '". $_GET["txtUsuario"]."'))";
